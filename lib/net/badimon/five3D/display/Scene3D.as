...
package net.badimon.five3D.display {
	...
	public class Scene3D extends Sprite {
		 ...
		 */
		public function get ambientLightVector():Vector3D {
			return __ambientLightVector;
		}

		public function set ambientLightVector(value:Vector3D):void {
		 ...
		 */
		public function get ambientLightVectorNormalized():Vector3D {
